...
public:
	...
	static Mesh* GenerateCylinder(const std::string& meshName, Color color, unsigned numSlice, float radius, float minHeight, float maxHeight);
	static Mesh* GenerateCircle(const std::string& meshName, Color color, unsigned numSlice, float outerR);
	...
	//static Mesh* GenerateSlicedQuad(const std::string& meshName, Color color, float x2, float z2);


	static Mesh* GenerateSlicedQuad(const std::string& meshName, Color color, int numSlice, float h, float v, float scaleX, float scaleZ);
};
